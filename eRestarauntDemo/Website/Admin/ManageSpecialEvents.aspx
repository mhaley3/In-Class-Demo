...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="SpecialEventsDataSource" runat="server" TypeName="eRestaraunt.Framework.BLL.RestaurantAdminController" 
        SelectMethod ="ListAllSpecialEvents" DataObjectTypeName="eRestaurant.Framework.Enteties.SpecialEvent"></asp:ObjectDataSource>
        ...
        <asp:ListView ID="SpecialEventsListView" runat="server" DataSourceID="SpecialEventsDataSource">
            ...
            <ItemTemplate>
                <div>
                    ...
                    &mdash;
                    <asp:Label ID="Label2" runat="server" AssociatedControlID="EventCodeData" CssClass="control-label">Event Code</asp:Label>
